...
INSERT INTO USER_INFO VALUES(USER_NO.NEXTVAL, '9bonseong', '1234', '구본성', '010-4773-9853');
INSERT INTO USER_INFO VALUES(USER_NO.NEXTVAL, 'jjaisson', '1234', '짜이쑨', '010-1234-5678');
INSERT INTO USER_INFO VALUES(USER_NO.NEXTVAL, 'sejinin', '1234', '세지닌', '010-2345-6789');
INSERT INTO USER_INFO VALUES(USER_NO.NEXTVAL, 'choongmanddi', '1234', '충만띠', '010-3456-7890');
INSERT INTO USER_INFO VALUES(USER_NO.NEXTVAL, 'maegwijjeol', '1234', '매귀쩔', '010-4567-8901');
INSERT INTO USER_INFO VALUES(USER_NO.NEXTVAL, 'aaa', '111', '매귀쩔', '010-4567-8901');
...
INSERT INTO ACCOUNT VALUES (ACC_NO.NEXTVAL, '1000', 1, '111-222-333', 1000000, '1234', '주택청약');
INSERT INTO ACCOUNT VALUES (ACC_NO.NEXTVAL, '2000', 2, '222-555-666', 2000000, '4321', '적금');
INSERT INTO ACCOUNT VALUES (ACC_NO.NEXTVAL, '3000', 3, '333-888-999', 3000000, '1234', '비트코인');
INSERT INTO ACCOUNT VALUES (ACC_NO.NEXTVAL, '3000', 3, '333-345-678', 3000000, '1111', '비상금');
INSERT INTO ACCOUNT VALUES (ACC_NO.NEXTVAL, '4000', 4, '444-645-545', 4000000, '1111', '밥값');
