			...
			<ul class="nav align-items-center d-md-none">
				...
				<li class="nav-item dropdown"><a class="nav-link" href="#"
					...
					<div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
						...
						<a
							href="${ pageContext.request.contextPath }/resources/examples/profile.html"
			...
			<div class="collapse navbar-collapse" id="sidenav-collapse-main">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link "
						href="${ pageContext.request.contextPath }/resources/examples/icons.html">
							<i class="ni ni-planet text-blue"></i> Icons
					</a></li>
					<li class="nav-item"><a class="nav-link "
						href="${ pageContext.request.contextPath }/resources/examples/maps.html">
					...
					<li class="nav-item"><a class="nav-link "
						href="${ pageContext.request.contextPath }/resources/examples/tables.html">
							<i class="ni ni-bullet-list-67 text-red"></i> Tables
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="${ pageContext.request.contextPath }/resources/examples/login.html">
							<i class="ni ni-key-25 text-info"></i> Login
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="${ pageContext.request.contextPath }/resources/examples/register.html">
				...
				<ul class="navbar-nav">
					<li class="nav-item active active-pro"><a class="nav-link"
						href="${ pageContext.request.contextPath }/resources/examples/upgrade.html">
