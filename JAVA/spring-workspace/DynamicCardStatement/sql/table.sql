...
DROP TABLE CARD;
CREATE TABLE CARD (
    CARD_CODE VARCHAR2(10) CONSTRAINT CARD_CARD_CODE_PK PRIMARY KEY,
    CARD_NAME VARCHAR2(60) CONSTRAINT CARD_CARD_NAME_UK UNIQUE,
...
CREATE TABLE CREDIT_CARD_NOTICE (
    NOTICE_NO NUMBER DEFAULT CREDIT_CARD_NOTICE_SEQ.NEXTVAL CONSTRAINT CREDIT_CARD_NOTICE_NOTICE_NO_PK PRIMARY KEY,
    CARD_NAME VARCHAR2(60),
    EDUCATION VARCHAR2(500),
    AUTOMOBILES VARCHAR2(500),
    SHOPPING VARCHAR2(500),
    LEISURE VARCHAR2(500),
    PRIORITY_PASS VARCHAR2(500),
    FINANCE VARCHAR2(500),
    AIR_MILEAGE VARCHAR2(500),
    BEAUTY VARCHAR2(500),
    COMMUNICATION VARCHAR2(500),
    EAT_OUT VARCHAR2(500),
    NATIONAL_VOUCHER VARCHAR2(500),
    CULTURE VARCHAR2(500),
    CAFE_BAKERY VARCHAR2(500),
    MEDICAL VARCHAR2(500),
    PREMIUM VARCHAR2(500),
    ANNUAL_FEE_SUPPORT VARCHAR2(500),
    VOUCHER VARCHAR2(500),
    ALWAYS_DISCOUNT VARCHAR2(500),
    PUBLIC_TRANSPORTATION VARCHAR2(500),
    MOVIE VARCHAR2(500),
    POINT_CASHBACK VARCHAR2(500),
    EASY_PAY VARCHAR2(500),
    HYPERMART VARCHAR2(500),
    RENTAL VARCHAR2(500),
    OIL VARCHAR2(500),
    MAINTENANCE VARCHAR2(500),
    CVS VARCHAR2(500),
    CONSTRAINT CREDIT_CARD_NOTICE_CARD_NAME_FK FOREIGN KEY(CARD_NAME) REFERENCES CARD(CARD_NAME)
);
