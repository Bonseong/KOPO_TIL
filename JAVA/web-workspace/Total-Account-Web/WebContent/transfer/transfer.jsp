			...
			<div id="signupbox"
				...
				<div class="panel panel-info">
					<div class="panel-heading">
						<div class="panel-title">계좌이체</div>
					</div>
					<div class="panel-body">
						<form id="openAccountform"
							action="<%=request.getContextPath()%>/transferProcess.do"
							method="post" class="form-horizontal" role="form">
							<div class="form-group">
								<label for="bank" class="col-md-3 control-label">은행명</label>
								<div class="col-md-9">
									<input type="text" class="form-control" name="sendingBankName"
							...
							<div class="form-group">
								<label for="bankName" class="col-md-3 control-label">이체할<br>은행</label>
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control"
										name="receivingAccNo" placeholder="Account Number to Transfer"
										required>
								</div>
							</div>
