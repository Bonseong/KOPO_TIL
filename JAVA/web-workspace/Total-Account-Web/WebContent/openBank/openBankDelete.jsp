			...
			<div id="signupbox"
				...
				<div class="panel panel-info">
					<div class="panel-heading">
						<div class="panel-title">오픈뱅킹 등록해지</div>


					</div>
					<div class="panel-body">
						<form id="openBankDelete"
							action="<%=request.getContextPath()%>/openBankDeleteProcess.do"
							...
							<div class="form-group">
								<label for="accNo" class="col-md-3 control-label">해지할 타행<br>계좌번호
								</label>

								<div class="col-md-9">
									<select class="form-control" name="openAcc" required>
										<c:forEach items="${ deleteAccList }" var="deleteAccList"
											varStatus="loop">
											<option value="${ deleteAccList.openAccList }" />
											<c:out value="${ deleteAccList.openAccList }" />
										</c:forEach>
									</select>
								</div>
