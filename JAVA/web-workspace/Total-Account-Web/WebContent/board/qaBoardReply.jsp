...
<body>
	...
	<section>
		<div align="center">
			...
			<hr width="80%">
			<br>
			<form action="<%=request.getContextPath()%>/qaBoardReplyProcess.do"
				...
				<table border="1" style="width: 80%" class="table table-bordered">
					<tr>
						...
						<td><input type="text" size="60" name="title"
							value="└${ board.title }" required readonly></td>
					</tr>
					<tr>
						<th width="25%">작성자</th>
					...
					<tr>
						<th width="25%">내용</th>
						<td><textarea rows="10" cols="150" name="content" required></textarea></td>
					</tr>
				</table>
