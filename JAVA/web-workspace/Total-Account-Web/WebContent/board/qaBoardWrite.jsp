...
<body>
	...
	<section>
		<div align="center">
			...
			<hr width="80%">
			<br>
			<form action="<%=request.getContextPath()%>/qaBoardWriteProcess.do" method="post" name="writeForm"
				onsubmit="return doWrite()" role="form">
				<input type = "hidden" name="writer" value="${userVO.id}">
				<table border="1" style="width: 80%" class="table table-bordered">
					<tr>
						<th width="25%">제목</th>
						<td><input type="text" size="60" name="title" required></td>
					</tr>
					<tr>
						<th width="25%">작성자</th>
					...
					<tr>
						<th width="25%">내용</th>
						<td><textarea rows="8" cols="60" name="content" required></textarea></td>
					</tr>
