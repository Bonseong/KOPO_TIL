				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<form id="openAccountform"
							action="<%=request.getContextPath()%>/modifyAccountPasswordProcess.do"
							...
							<div class="form-group">
								<label for="accPassword" class="col-md-3 control-label">변경할<br>계좌비밀번호
								</label>
								<div class="col-md-9">
							...
							<div class="form-group">
								<label for="accPassword" class="col-md-3 control-label">비밀번호<br>확인
								</label>
								<div class="col-md-9">
									<input type="password" class="form-control"
